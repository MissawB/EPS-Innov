...
################################ Écran des fonctionnalités pour le futsal ################################################
class FutsalScreen(Screen):
    ...
    def save_archive(self, custom_name, popup):
        ...
        if not custom_name:
            ...
            filename = f"{archive_dir}/archive_Futsal_{timestamp}.txt"
        else:
        ...
        with open(filename, 'w') as f:
            # Écrire "Futsal" pour indiquer le mode et ajouter la date et l'heure
            f.write(" Futsal\n")
